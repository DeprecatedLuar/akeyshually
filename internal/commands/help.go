...
var (
	...
	helpKeys = gohelp.NewPage("keys", "complete list of available key names").
		...
		Section("Editing",
			...
			gohelp.Item("capslock", "Caps Lock key"),
			gohelp.Item("numlock", "Num Lock key"),
			gohelp.Item("scrolllock", "Scroll Lock key"),
		).
		Section("Punctuation",
			gohelp.Item("semicolon", "Semicolon key (alias: ;)"),
			gohelp.Item("minus", "Minus/hyphen key"),
			gohelp.Item("equal", "Equal key"),
			gohelp.Item("comma", "Comma key"),
			gohelp.Item("dot", "Period key"),
			gohelp.Item("slash", "Forward slash key"),
			gohelp.Item("backslash", "Backslash key"),
			gohelp.Item("apostrophe", "Apostrophe key"),
			gohelp.Item("grave", "Grave/backtick key"),
			gohelp.Item("leftbrace", "Left bracket key"),
			gohelp.Item("rightbrace", "Right bracket key"),
		).
		Section("Media Keys",
		...
		Section("Special Keys",
			...
			gohelp.Item("menu", "Menu/context menu key"),
			gohelp.Item("pause", "Pause/Break key"),
		).
		Section("Mouse Buttons",
